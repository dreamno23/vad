...
int WebRtcVad_set_mode_core(VadInstT* self, int mode) {
  ...
  case 4:
          //custom
          memcpy(self->over_hang_max_1, kOverHangMax1Cus,
                 sizeof(self->over_hang_max_1));
          memcpy(self->over_hang_max_2, kOverHangMax2Cus,
                 sizeof(self->over_hang_max_2));
          memcpy(self->individual, kLocalThresholdCus,
                 sizeof(self->individual));
          memcpy(self->total, kGlobalThresholdCus,
                 sizeof(self->total));
